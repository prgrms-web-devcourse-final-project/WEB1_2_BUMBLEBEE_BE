...
public enum ErrorCode {
    ...
    /*WorkPlace*/
    WORKPLACE_NOT_REGISTERED(HttpStatus.BAD_REQUEST, "W001","사업장 등록에 실패하였습니다."),
    WORKPLACE_NOT_MODIFIED(HttpStatus.BAD_REQUEST,"W002","사업장 수정에 실패하였습니다."),
    WORKPLACE_NOT_DELETE(HttpStatus.BAD_REQUEST,"W003","사업장 삭제에 실패하였습니다."),
    WORKPLACE_NOT_FOUND(HttpStatus.BAD_REQUEST,"W004","존재하지 않는 사업장 입니다"),
