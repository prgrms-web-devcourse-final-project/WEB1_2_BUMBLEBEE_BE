...
public class ReservationController {
    ...
    public void updateReservation(@PathVariable Long reservationId, @RequestBody UpdateReservationRequest request) {
    ...
    public ReservationResponse findRecentReservationByMemberId(@PathVariable Long memberId) {
    ...
    public List<MyWorkPlaceReservationResponse> findReservationByWorkplaceId(@PathVariable Long workplaceId) {
